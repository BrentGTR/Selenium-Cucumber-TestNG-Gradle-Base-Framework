...
public class DriverFactory extends TestEnvironment {
    ...
    protected void startBrowser() {
        ...
        switch (getTestsExecutor().toLowerCase()) {
            ...
            case "safari":
                ...
                break;
            case "grid":
                addDriver(driver = remoteWebDriver(SELENIUM_GRID_URL, (DesiredCapabilities) getCapabilityForRemoteBrowser(getRemoteBrowserName().toLowerCase())));

                break;
            case "browserstack":
                DesiredCapabilities BrowserStackDesiredCapabilities = getDesiredCapabilities();
    ...
    private DesiredCapabilities getDesiredCapabilities() {
        ...
        if (getRemoteBrowserName().equalsIgnoreCase("ie")) {
        ...
        } else if (getRemoteBrowserName().equalsIgnoreCase("edge")) {
        ...
        } else if (getRemoteBrowserName().equalsIgnoreCase("firefox")) {
            BrowserStackDesiredCapabilities.setCapability("browser", "Firefox");
            BrowserStackDesiredCapabilities.setCapability("browserVersion", "latest");
        } else if (getRemoteBrowserName().equalsIgnoreCase("chrome")) {
        ...
        return BrowserStackDesiredCapabilities;
    }

    public Capabilities getCapabilityForRemoteBrowser(String browserName) {
        ...
        switch (browserName.toLowerCase()) {
            ...
            case "safari":
                ...
                SafariOptions safariOptions = new SafariOptions();
                safariOptions.setCapability("platform", "WINDOWS");
